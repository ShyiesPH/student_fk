                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <?php
                    include_once 'db.php';
                    $result = mysqli_query($conn, "SELECT students.id, students.name, students.email, students.mobile, courses.course_name FROM students JOIN courses ON students.course_id = courses.id");
