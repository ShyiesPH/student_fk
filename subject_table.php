                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <a href="subject_add.php" class="btn btn-primary float-right">Add Student Subjects </a>
                        ...
                        <div class="body">
                            ...
                            <?php
                    include_once 'db.php';
                    $result = mysqli_query($conn, "SELECT subjects.id, students.name FROM subjects JOIN students ON subjects.student_id = students.id");
