                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <a href="attendance_add.php" class="btn btn-primary float-right">Add Student Attendance </a>
                        ...
                        <div class="body">
                            ...
                            <?php
                    include_once 'db.php';
                    $result = mysqli_query($conn, "SELECT attendances.id, attendances.attendance_status, attendances.attendance_date, students.name FROM attendances JOIN students ON attendances.student_id = students.id");
                    //  $result = mysqli_query($conn, "SELECT * FROM attendances");
                    ...
                    ?>
                                    ...
                                    <td>
                                    <a href="attendance_view.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary" title='View Record'>View</a>
                                    <a href="attendance_update.php?id=<?php echo $row["id"]; ?>" class="btn btn-success" title='Update Record'>Update</a>
                                    <a href="attendance_delete.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger" title='Delete Record'>Delete</a>
                                    </td>  
