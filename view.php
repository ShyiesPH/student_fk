...
include("auth_session.php");
    ...
    // $result = mysqli_query($conn,"SELECT * FROM students WHERE id='" . $_GET['id'] . "'");//42
    $result = mysqli_query($conn, "SELECT students.id, students.name, students.email, students.mobile, courses.course_name FROM students JOIN courses ON students.course_id = courses.id WHERE students.id='" . $_GET['id'] . "'");
                    ...
                    <div class="card profile-card">
                        ...
                        <div class="profile-body">
                            ...
                            <div class="content-area">
                                ...
                                <p>Mobile: +63<?php echo $row["mobile"]; ?></p>
                                            ...
                                            <div class="panel-heading">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            <img src="includes/images/user-lg.jpg" />
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="post">
                                                    ...
                                                    <div class="post-content">
                                                        <img src="includes/images/profile-post-image.jpg" class="img-responsive" />
                                                    </div>
                                                </div>
                                            </div>
