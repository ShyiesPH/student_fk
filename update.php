...
if(isset($_POST['save'])) {
    ...
    $sql = "UPDATE students SET name='$name', mobile='$mobile', email='$email', course_id='$course_id' WHERE id='" . $_GET['id'] . "'";
        ...
        <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <label for="name">Name</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" maxlength="50" placeholder="Enter your Name" name="name1" value="<?php echo $student_data['name']; ?>">
                                    </div>
                                </div>
                                <label for="email_address">Email Address</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="email" id="email_address" class="form-control" maxlength="30"  placeholder="Enter your email address" name="email" value="<?php echo $student_data['email']; ?>">
                                    </div>
                                </div>
                                <label for="mobile">Mobile Number</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="mobile" id="mobile" class="form-control" maxlength="12" placeholder="Enter your Number" name="mobile" value="<?php echo $student_data['mobile']; ?>">
                                    </div>
                                </div>
            ...
            <select class="form-control show-tick" data-live-search="true" name="course_id" id="course">
                ...
                <?php while ($course = mysqli_fetch_assoc($courses_query)): ?>
                    <option value="<?= htmlspecialchars($course['id']) ?>" <?= ($student_data['course_id'] == $course['id']) ? 'selected' : ''; ?>>
